        ...
        <Container
          ...
          <Stack
            ...
            <Text mb={'2rem'}>
              ...
              to express himself. Currently, he is fully immersed in the
              creative process, diligently working on his latest projects. Each
              canvas holds a unique story waiting to be unveiled.
            </Text>
            <Link
              mb={'2rem'}
              maxW={'fit-content'}
          ...
          <Box>
            ...
            <Text mb={'1rem'}>
              ...
              unseen. Within each individual, there are secrets and untold
              stories yearning to be expressed. There is always more...
            </Text>
            <Text mb={'1rem'}>
              <Highlight
                query={'taNrleMn'}
                ...
                journey through life in search of answers to heal or make the
                pain disappear. The artist, taNrleMn, strongly believes in the
                transformative power of connection and the importance of
                exploring the hidden depths of others to gain new perspectives
                on healing our own wounds. We are all teachers on this healing
                journey.
              </Highlight>
            </Text>
            <Text mb={'1rem'}>
            ...
            <Text mb={'1rem'}>
              <Highlight
                ...
                and anguish of existence. For taNrleMn, painting becomes a
                medium for sharing and mutual understanding—a tool to aid in the
                healing process.
              </Highlight>
            </Text>
          </Box>
