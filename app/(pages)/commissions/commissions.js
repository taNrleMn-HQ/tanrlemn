        ...
        <Box>
          ...
          <OrderedList mb={'3rem'}>
            <ListItem mb={'1rem'}>
              <Highlight
                ...
                speaks to you, or if you have a vision of your own, let’s start
                the conversation!
              </Highlight>
            </ListItem>
            <ListItem mb={'1rem'}>
            ...
            <ListItem mb={'1rem'}>
              <Highlight
                ...
                Progress updates and insights into the creative process will be
                provided.
              </Highlight>
            </ListItem>
            <ListItem mb={'1rem'}>
          ...
          <Text mb={'1rem'}>
            <Highlight
              ...
              of your personal story and aesthetic.
            </Highlight>
          </Text>
          <Text mb={'1rem'}>
            <Highlight
          ...
          <Box
            ...
            <Text mb={'1.5rem'}>
              ...
              us today to begin your commission journey with taNrleMn.
            </Text>
            <Button
              maxW={'fit-content'}
              onClick={onOpen}
